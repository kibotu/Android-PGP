...
final public class Pgp {
    ...
    private static BcKeyFingerprintCalculator bcKeyFingerprintCalculator = new BcKeyFingerprintCalculator();

    private static byte[] publicKey;
    private static byte[] privateKey;

    public static void setPrivateKey(@NonNull String privateKey) {
        Pgp.privateKey = privateKey.getBytes();
    }

    public static void setPublicKey(@NonNull String publicKey) {
        Pgp.publicKey = publicKey.getBytes();
    }
    ...
    public static String decrypt(String encryptedText, String password) throws Exception {
        ...
        if (pbe != null) {
            ...
            PGPObjectFactory pgpFact = new PGPObjectFactory(clear, bcKeyFingerprintCalculator);
    ...
    public static String encrypt(String msgText) throws IOException, PGPException {
        ...
        PGPPublicKeyRing pgpPublicKeyRing = getPGPPublicKeyRing();
        ...
        PGPEncryptedDataGenerator encGen =
                new PGPEncryptedDataGenerator(
                        new JcePGPDataEncryptorBuilder(PGPEncryptedData.AES_256).setWithIntegrityPacket(true).setSecureRandom(
                                new SecureRandom()).setProvider(BouncyCastleProvider.PROVIDER_NAME));
        if (encKey != null) {
    ...
    public static PGPKeyRingGenerator generateKeyRingGenerator(char[] pass) throws PGPException {
    ...
    private static PGPPublicKeyRing getPGPPublicKeyRing() throws IOException {
        ...
        PGPObjectFactory pgpObjectFactory = new PGPObjectFactory(ais, bcKeyFingerprintCalculator);
        return (PGPPublicKeyRing) pgpObjectFactory.nextObject();
    }
    ...
    private static PGPSecretKeyRing getPGPSecretKeyRing() throws IOException {
        ...
        return (PGPSecretKeyRing) new PGPObjectFactory(ais, bcKeyFingerprintCalculator).nextObject();
    }

    public static String genPGPPublicKey(PGPKeyRingGenerator krgen) throws IOException {
    ...
    public static String genPGPPrivKey(PGPKeyRingGenerator krgen) throws IOException {
